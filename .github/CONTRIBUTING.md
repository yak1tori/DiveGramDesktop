...
This document describes how you can contribute to DiveGram Desktop.
...
We highly appreciate your contributions in the matter of fixing bugs and optimizing the DiveGram Desktop source code and its documentation. In case of fixing the existing user experience please push to your fork and [submit a pull request][pr].
...
To pull in upstream changes:
    ...
    git remote add upstream https://github.com/DiveGram/DiveGramDesktop.git
...
We want to improve DiveGram Desktop with your contributions. But we also want to provide a stable experience for our users and the community. Follow these rules and you should succeed without a problem!
...
[pr]: https://github.com/DiveGram/DiveGramDesktop/compare
[build_instructions]: https://github.com/DiveGram/DiveGramDesktop/blob/dev/docs
[closing-issues-via-commit-messages]: https://help.github.com/articles/closing-issues-via-commit-messages/
[translate]: https://crowdin.com/project/divegram
[android_repo]: https://github.com/DiveGram/DiveGram4A

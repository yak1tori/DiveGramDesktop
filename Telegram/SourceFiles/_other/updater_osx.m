...
void RemoveQuarantineFromBundle(NSString *path) {
	...
	RemoveQuarantineAttribute([path stringByAppendingString:@"/Contents/MacOS/DiveGram"]);
...
int main(int argc, const char * argv[]) {
	...
	if (update) {
		...
		// so it won't be deleted when we will clear the "DiveGram.app/Contents" folder.

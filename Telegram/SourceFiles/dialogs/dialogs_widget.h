...
#include "dialogs/ui/dialogs_glass.h"
...
private:
	...
	Ui::Animations::Simple _wheelScrollAnimation;
	int _wheelScrollTo = 0;
	...
	GlassWallpaper _glass;

	Ui::RpWidget *_searchGlassOverlay = nullptr;

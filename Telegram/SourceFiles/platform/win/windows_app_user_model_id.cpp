...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"DiveGram.DiveGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"DiveGram.DiveGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"DiveGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"DiveGram Desktop/DiveGram.lnk"_q;
	const auto old = u"DiveGram for Windows/DiveGram.lnk"_q;

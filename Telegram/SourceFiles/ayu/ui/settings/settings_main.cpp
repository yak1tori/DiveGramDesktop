...
void BuildCategories(SectionBuilder &builder) {
	...
	builder.addSectionButton({
		.title = rpl::single(QString("DiveGram")),
...
void BuildLinks(SectionBuilder &builder) {
	...
	builder.addButton({
		...
		.label = rpl::single(QString("@divegram")),
		.onClick = [=] {
			controller->showPeerByLink(Window::PeerByLinkInfo{
				.usernameOrId = QString("divegram"),
			});
		},
	});
	builder.addButton({
		...
		.label = rpl::single(QString("@divegramchat")),
		.onClick = [=] {
			controller->showPeerByLink(Window::PeerByLinkInfo{
				.usernameOrId = QString("divegramchat"),
			});
		},
	});
	builder.addButton({
		...
		.onClick = [=] {
			QDesktopServices::openUrl(
				QString("https://translate.divegram.app"));
		},
	});
	builder.addButton({
		.id = u"ayu/website"_q,
		...
		.label = rpl::single(QString("docs.divegram.app")),
		.onClick = [=] {
			QDesktopServices::openUrl(
				QString("https://docs.divegram.app"));
		},
	});
